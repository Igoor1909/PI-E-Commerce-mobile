...
class CadastroActivity : AppCompatActivity() {
    ...
    private fun registerUser() {
        ...
        val cadastroRequest = CadastroRequest(email, password, nome, "register")
    ...
    data class CadastroRequest(val email: String, val password: String, val nome: String, val action: String = "register")
